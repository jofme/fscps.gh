    ...
    {                  
        ...
        if($settings.generatePackages)
        {
            ...
            if($settings.uploadPackageToLCS)
            {
                ...
                Get-D365LcsApiToken -ClientId $settings.lcsClientId -Username "$lcsUsernameSecretname" -Password "$lcsPasswordSecretName" -LcsApiUri "https://lcsapi.eu.lcs.dynamics.com" -Verbose | Set-D365LcsApiConfig -ProjectId $settings.lcsProjectId -LcsApiUri 'https://lcsapi.eu.lcs.dynamics.com'
